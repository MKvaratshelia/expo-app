...
export default function MyCourses() {
	...
	const allowsNotification = async () => {
		...
		return settings.granted || settings.ios?.status == Notificaitons.IosAuthorizationStatus.PROVISIONAL;
	};
	...
	return (
		<>
			...
			{courses.length > 0 && (
				// оптимизирует отрисовку  списка
				<FlatList
					// перезашгружаем когда тянем вниз
					refreshControl={
						<RefreshControl
